        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <Link to="/report" style={{ 
              ...
              padding: '8px 16px',
              borderRadius: 8,
              background: location.pathname === '/report' ? '#eff6ff' : 'transparent'
            }}>
              智能报告生成
            </Link>
            <Link to="/conversation" style={{ 
              textDecoration: 'none', 
              color: location.pathname === '/conversation' ? '#3b82f6' : '#6b7280',
              padding: '8px 16px',
              borderRadius: 8,
              background: location.pathname === '/conversation' ? '#eff6ff' : 'transparent'
            }}>
              舆情咨询
            </Link>
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'monospace', fontSize: 14, color: '#374151' }}>
            <div style={{ fontWeight: 700, marginBottom: 12 }}># 舆情分析报告</div>
